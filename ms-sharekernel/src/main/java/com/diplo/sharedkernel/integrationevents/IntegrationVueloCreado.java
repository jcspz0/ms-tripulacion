...
public class IntegrationVueloCreado {
	...
	public IntegrationVueloCreado(String idVuelo, String origen, String destino, String horaPartida, String horaLlegada,
			String idAeronave, String timestamp, int cantidadAsientos) {
		super();
		IdVuelo = idVuelo;
		Origen = origen;
		Destino = destino;
